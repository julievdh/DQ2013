% The bigger animal  - Lono: DOB 1.1.85; Wt: 544 lbs; Length: 108 in
% The smaller animal - Nainoa: DOB 10.31.97; Wt: 395 lbs; Length: 97.5 in


speed = (linspace(1,6,100))';
Thrust_model = (28.87*speed.^2.91); %(W)
pFit = 1;
...
LA2_amp = stroke_amp;
LA2_freq = stroke_freq;
LA2_period = stroke_period;
...
% figure
% 
% plot(LA_Vfave,LA_Thrust*244,'.k','MarkerFaceColor',[0.960784316062927 0.921568632125854 0.921568632125854],...
%     'Marker','o',...
%     'LineStyle','none',...
%     'Color',[0.960784316062927 0.921568632125854 0.921568632125854]);
% hold on
% plot(speed, Thrust_model)
%%
load Nainoa_A
NA_Thrust = net_trust;
NA_Drag = net_drag;
...
load Nainoa_A2
NA2_Thrust = net_trust;
NA2_Drag = net_drag;
NA2_Vfave = Vfave';
NA2_amp = stroke_amp;
NA2_freq = stroke_freq;
NA2_period = stroke_period;
