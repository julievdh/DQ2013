...
% Unloading
clear all
load('LonoLoadUnloadSpeed'); % these are speed data, what about lap data?
...
plot(C.Usurf_arr(:,2),C.Usurf_arr(:,3),'k','LineWidth',2)
plot(T.Usurf_arr(:,2),T.Usurf_arr(:,3),'Color',[55/255 126/255 184/255],'LineWidth',2)
plot(T2.Usurf_arr(:,2),T2.Usurf_arr(:,3),'Color',[255/255 127/255 0/255],'LineWidth',2)
