...
Speed_mean = mean(Speed(39769:99684))
Speed_SD = std(Speed(39769:99684))

save LonoA4_SpeedandDist Speed time Speed_mean Speed_SD Distance 
%% Plot data
