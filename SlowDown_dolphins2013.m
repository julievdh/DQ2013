...
plot(vel,notag,'k')
plot(vel,tag(:,1)+tag(:,2),'color',[55/255 126/255 184/255])
plot(vel,tag2(:,1)+tag2(:,2),'color',[255/255 127/255 0/255])
plot(vel,tag4(:,1)+tag4(:,2),'color',[77/255 175/255 74/255])
...
% plot to check
plot(Ured_tag4,c_tag4(1)*Ured_tag4.^c_tag4(2),'kd','markerfacecolor',[55/255 126/255 184/255])
plot(Ured_tag2,c_tag2(1)*Ured_tag2.^c_tag2(2),'ko','markerfacecolor',[255/255 127/255 0/255])
