...
%% Lono Assume 70 F temp for the warer
l = 2.74; %m
m = 247; %kg
density = 1029; % density of Sea water kg/m^3

Cd = 0.01274129; %From CFD
...
%% Plot the Powers
    ...
    %% Save the Data
    Lono_A4_Power = struct('Power',Power,'Work',Work,'Work_ave',Work_ave,'Force', Force, 'Force_ave',Force_ave,'Params', Params)
    save Lono_A4_Power Lono_A4_Power
