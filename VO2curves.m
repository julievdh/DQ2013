...
for i = 1:size(filenames,1)
    ...
    if isempty(strfind(filenames{i},'C')) == 0
        h = plot(post(:,12)/12000,post(:,6),'ko-');
        if isempty(strfind(filenames{i},'Nainoa')) == 0
            set(h,'markerfacecolor','k')
        end
    else
        if isempty(strfind(filenames{i},'A2')) == 0
            h = plot(post(:,12)/12000,post(:,6),'d-','color',[26/255 150/255 65/255]);
            if isempty(strfind(filenames{i},'Nainoa')) == 0
                set(h,'markerfacecolor',[26/255 150/255 65/255])
            end
        else
            h = plot(post(:,12)/12000,post(:,6),'^-','color',[5/255 113/255 222/255]);
            if isempty(strfind(filenames{i},'Nainoa')) == 0
                set(h,'markerfacecolor',[5/255 113/255 222/255])
            end
        end
    end
    %
...
for i = 1:size(filenames,1)
    ...
    if isempty(strfind(filenames{i},'C')) == 0
        ...
        if isempty(strfind(filenames{i},'A2')) == 0
            h = plot(VO2,VCO2,'d','color',[26/255 150/255 65/255]);
            if isempty(strfind(filenames{i},'Nainoa')) == 0
            set(h,'markerfacecolor',[26/255 150/255 65/255])
        end
        else
            h = plot(VO2,VCO2,'^','color',[5/255 113/255 222/255]);
                        if isempty(strfind(filenames{i},'Nainoa')) == 0
            set(h,'markerfacecolor',[5/255 113/255 222/255])
        end
        end
