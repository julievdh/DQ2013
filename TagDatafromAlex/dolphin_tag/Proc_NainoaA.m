...
Speed_mean = mean(Speed(50041:110508))
Speed_SD = std(Speed(50041:110508))

save NainoaA_SpeedandDist Speed time Speed_mean Speed_SD Distance 
...
title('Nainoa A')
axis([45000 115000 -15 20])

subplot(312)
plot(inertial_results.Vm_kf)
xlabel('Samples')
ylabel('Velocity (m/s)')
axis([45000 115000 0 6])
