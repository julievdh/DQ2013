...
%% Nainoa Assume 70 F temp for the warer
    ...
    Cd = 0.008*.8; % Coeffiecent of drag from CFD
...
%% Plot the Powers
    ...
    Nainoa_A_Power = struct('Power',Power,'Work',Work,'Work_ave',Work_ave,'Force', Force, 'Force_ave',Force_ave,'Params', Params)
    
    save Nainoa_A_Power Nainoa_A_Power
