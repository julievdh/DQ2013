...
plot(h1,0,dur_load0,'ko','MarkerFaceColor','k','MarkerSize',10)
plot(h1,1,dur_loadA,'k^','MarkerFaceColor',[55/255 126/255 184/255],'MarkerSize',10)
plot(h1,2,dur_loadA1,'ko','MarkerFaceColor',[255/255 127/255 0/255],'MarkerSize',10)
plot(h1,3,dur_loadA2,'kd','MarkerFaceColor',[77/255 175/255 74/255],'MarkerSize',10)
plot(h1,4,dur_loadA3,'ko','MarkerFaceColor',[152/255 78/255 163/255],'MarkerSize',10)
plot(h1,5,dur_loadA4,'ks','MarkerFaceColor',[228/255 26/255 28/255],'MarkerSize',10)

plot(h1,11,dur_remove0,'ko','MarkerFaceColor','k','MarkerSize',10)
plot(h1,10,dur_removeA,'k^','MarkerFaceColor',[55/255 126/255 184/255],'MarkerSize',10)
plot(h1,9,dur_removeA1,'ko','MarkerFaceColor',[255/255 127/255 0/255],'MarkerSize',10)
plot(h1,8,dur_removeA2,'kd','MarkerFaceColor',[77/255 175/255 74/255],'MarkerSize',10)
plot(h1,7,dur_removeA3,'ko','MarkerFaceColor',[152/255 78/255 163/255],'MarkerSize',10)
plot(h1,6,dur_removeA4,'ks','MarkerFaceColor',[228/255 26/255 28/255],'MarkerSize',10)
...
% plot
plot(h2,1:5,[p0A p0A1 p0A2 p0A3 p0A4],'k')
plot(h2,6:10,[pA40 pA30 pA20 pA10 pA0],'k')

%% figure(3): Plot increasing and decreasing on same axis
...
warning off
set(gca,'xtick',0:11,'xticklabels',{'C','T','T+2','T+4','T+6','T+8','T+8','T+6','T+4','T+2','T','C'})
